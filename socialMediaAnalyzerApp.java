...
public class socialMediaAnalyzerApp {
  ...
  public void addPost(Post post) {
    ...
    // Check if the posts LinkedHashMap already contains the postId
  ...
  public void appendPost() {
    ...
    try (FileWriter writer = new FileWriter("posts.csv", true)) {
  ...
  public void savePosts() {
    ...
    try (FileWriter writer = new FileWriter("posts.csv", false)) { // false for overwrite
